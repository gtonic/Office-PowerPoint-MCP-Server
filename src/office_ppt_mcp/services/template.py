"""
Template Service for managing PowerPoint templates.

Handles template discovery, loading, and management operations.
"""
import os
...
class TemplateService:
    ...
    def find_template(self, template_name: str) -> str:
        """
