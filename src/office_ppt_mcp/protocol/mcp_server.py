...
Handles FastMCP server setup and coordinates tool registration across modules.
"""
import os
...
from ..adapters.template_adapter import get_template_search_directories
...
# Global state to store presentations in memory (legacy support)
presentations = presentation_service.presentations
...
def get_current_presentation():
    ...
    return presentation_service.get_current_presentation()


def get_current_presentation_id():
    """Get the current presentation ID."""
    return presentation_service.get_current_presentation_id()
...
def set_current_presentation_id(pres_id):
    ...
    presentation_service.set_current_presentation_id(pres_id)
